...
async function handleCreateRace() {
    ...
    return alert('You have to choose a racer and track.');
	...
	try {
		...
		console.log("Problem with handling create race: ", error);
	} 
}
...
function handleAccelerate() {
	try {
		...
		console.error(`Problem with handling accelerate request: ${error}`)
	}
}
...
function getTracks() {
	...
	.catch(error => console.error(`Problem with getting tracks: ${error}`))
}

function getRacers() {
	return fetch(`${SERVER}/api/cars`)
	.then(response => response.json())
	.catch(error => console.error(`Problem with getting cars: ${error}`))
}
...
function getRace(id) {
	...
	.then(response => response.json())
	.catch(err => console.error(`Problem with getting id: ${err}`))
}
